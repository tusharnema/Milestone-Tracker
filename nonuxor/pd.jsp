...
<li><a href="pd.jsp">Project Details</a> <span class="divider">>></span></li>
  ...
  <div class="row">
    ...
    <li><a data-toggle="pill" href="#menu1">Add/View Members
...
<div class="form-group">
  <label class="col-md-6 control-label" for="product_id">NAME</label>  
  <div class="col-md-6">
...
<div class="form-group">
 ...
 <center> <label class="col-md-6 control-label" for="product_id"><%=rs1.getString("member_name")%></label>  </center>
...
<!-- Select Basic -->
<div class="form-group">
  <center><label class="col-md-6 control-label" for="product_categorie"><%=rs1.getString("user_type")%></label></center>
...
<div class="col-md-4">
<form action = "deleteMem.jsp" onsubmit="return confirm('Do you really want to Remove this Member?')">
<input type = "hidden" name = "memname" value = "<%=rs1.getString("MEMBER_NAME")%>" />
<input type = "hidden" name = "projectId" value = "<%=projectSes%>" />
...
<%} if (mem==0){%>
Please Add Members for the Project. <%}mem=0;%>
