...
try{
    ...
    call = connection.prepareCall("{call erp.CL_INNOVATION_PKG.LIST_PROJECT_STUDENTS(?,?)}");
...
<div class="col-md-8">
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#Fin">Completed projects</a></li>
  </ul>
</div>
<div class="col-md-4">
...
<!-- Active projects -->
 ...
 <div class="white">
  <div class="col-sm-6">
  <a href = "pd_student.jsp?projectId=<%=rs.getInt("PROJECT_ID")%>"><h5> Project details</h5></a></div>
    <div class="col-sm-6">
 <a href = "project_p/project_new_STUDENT.jsp?projectId=<%=rs.getInt("PROJECT_ID")%>"><h5> Project progress</h5></a></br> </div>
  </div>
    ...
    <div id="Fin" class="tab-pane fade ">
      ...
      <div id="Fin" class="tabcontent " >
        <div class="more-services-container section-container" background-color="#ccffcc" >
          <div class="container">
        <center> <h1>   No projects Completed yet  <h1> </center>
         <!--    <div class="row">
                  <div class="col-sm-6 more-services section-description wow fadeIn">
